...
import com.durranitech.taskalert.repositories.ResetPasswordRepository
...
fun PasswordResetScreen(context: Context, navController: NavController) {
    ...
    Column(
        ...
        Button(
            ...
            Text(text = "Recover Password", color = colorResource(id = R.color.custom_white), fontSize = 18.sp)
