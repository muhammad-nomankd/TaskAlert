...
class TaskListScreen : androidx.activity.ComponentActivity() {
    ...
    fun TaskListScreen(navController: NavController) {
        ...
        val calendar =
            rememberSaveable { android.icu.util.Calendar.getInstance() }
        ...
        val selectedCategoryState by androidx.compose.runtime.remember {
            mutableStateOf(
                "All"
            )
        }
        ...
        var showPickerDialogue: Boolean by rememberSaveable {
            mutableStateOf(
                false
            )
        }
        val context = androidx.compose.ui.platform.LocalContext.current
        var refreshtaskforday by rememberSaveable {
            mutableStateOf(
                false
            )
        }
        ...
        val snackbarHost by androidx.compose.runtime.remember {
            mutableStateOf(
                SnackbarHostState()
            )
        }
            ...
            if (showPickerDialogue) {
                ...
                DatePickerDialogueShow(
                    onDateSelected = { year, month, day ->
                        ...
                        refreshtaskforday = true
                    }, context = context, calendar = calendar as Calendar
                )
    ...
    fun DatePickerDialogueShow(
        onDateSelected: (Int, Int, Int) -> Unit, context: Context, calendar: Calendar
    ) {
            ...
            Row(
                ...
                Box(
                    modifier = Modifier
                        ...
                        .width(4.dp)
                        .background(
                            colorResource(id = R.color.box_color), shape = RoundedCornerShape(4.dp)
                        )
                )
                Column(
                    modifier = Modifier
